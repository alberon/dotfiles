...
if v:version < 700
    "DJM echoerr "NERDTree: this plugin requires vim >= 7. DOWNLOAD IT! You'll thank me later!"
    finish
endif
...
"DJM This doesn't work with a case-sensitive filesystem (https://github.com/scrooloose/nerdtree/issues/69)
...
function! s:closeTreeWindow()
    if b:NERDTreeType ==# "secondary" && b:NERDTreePreviousBuf != -1
        ...
        if winnr("$") > 1
            ...
            quit "DJM
            "DJM call s:echo("Cannot close last window")
        endif
    endif
endfunction
