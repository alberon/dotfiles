...
"DJM imap <Leader>ih <ESC>:IHS<CR>
"DJM nmap <Leader>ih :IHS<CR>
"DJM imap <Leader>is <ESC>:IHS<CR>:A<CR>
"DJM nmap <Leader>is :IHS<CR>:A<CR>
"DJM imap <Leader>ihn <ESC>:IHN<CR>
"DJM nmap <Leader>ihn :IHN<CR>
