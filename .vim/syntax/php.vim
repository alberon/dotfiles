...
if s:long_tags
  syn region phpRegion matchgroup=phpRegionDelimiter start=/<?php\w\@!/ end=/?>/
        \ keepend contains=@phpClTop
"DJM        \ keepend extend contains=@phpClTop
else
  syn region phpRegion matchgroup=phpRegionDelimiter start=/<?\(php\w\@!\|=\)\=/ end=/?>/
        \ keepend contains=@phpClTop
"DJM        \ keepend extend contains=@phpClTop
" This fixes the following highlighting:
" <p>More to come soon!<sup title="<?php echo $f1 = "Note: I've been saying that for about 10 years!" ?>">*</sup></p>
endif
